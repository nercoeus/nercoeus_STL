#ifndef _NER_STL_REVERSE_ITERATOR_H_
#define _NER_STL_REVERSE_ITERATOR_H_
...
class reverse_iterator_t
{
  ...
  /*
  template <class Iterator>
	friend bool operator==(reverse_iterator_t<Iterator> &lhs,
						   reverse_iterator_t<Iterator> &rhs);
	template <class Iterator>
	friend bool operator!=(reverse_iterator_t<Iterator> &lhs,
						   reverse_iterator_t<Iterator> &rhs);
	template <class Iterator>
...
{
	base_ = advance_n(base_, n, false, iterator_category());
	cur_ = advance_n(cur_, n, false, iterator_category());
	return *this;
}
template <class Iterator>
reverse_iterator_t<Iterator> &reverse_iterator_t<Iterator>::operator-=(difference_type n)
{
	base_ = advance_n(base_, n, true, iterator_category());
	cur_ = advance_n(cur_, n, true, iterator_category());
	return *this;
}
template <class Iterator>
